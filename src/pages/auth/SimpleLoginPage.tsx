...
import { Form, Input, Button, Checkbox, message, Typography, Card, Tabs } from 'antd';
import { UserOutlined, LockOutlined, MailOutlined, PhoneOutlined, WechatOutlined, QqOutlined, AlipayOutlined, WeiboOutlined } from '@ant-design/icons';
