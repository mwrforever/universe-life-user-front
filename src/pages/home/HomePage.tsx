...
import {ErrorBoundary, PullToRefresh} from './components/ui';
import {AntiFraudModal, CustomerService, StatisticsBanner} from './components/special';
import {useHomeData, useTaskFilter} from './hooks';
import type {BannerItem, GridItem, Task} from './types';
...
export const HomePage: React.FC = () => {
    ...
    const handleTaskFavorite = (taskId: string, isFavorite: boolean) => {
        ...
        // 实现收藏逻辑
        void message.success(isFavorite ? '已添加收藏' : '已取消收藏');
    };
